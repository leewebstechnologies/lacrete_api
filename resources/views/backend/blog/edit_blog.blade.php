        ...
        <div class="row">
            <div class="col-xl-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form id="myForm" action="{{ route('update.blog') }}" method="post" class="row g-3" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="col-md-6">
                                    <img id="showImage" src="{{ asset($blog->image) }}" class="rounded-circle avatar-xxl img-thumbnail float-start" alt="image profile">
                            </div>

                            <div class="col-md-12">
                                <label for="validationDefault01" class="form-label">Blog Short Description</label>
                                <textarea class="form-control" name="desc" placeholder="Add Short Description">{{ $blog->desc }}</textarea>
                            </div>
