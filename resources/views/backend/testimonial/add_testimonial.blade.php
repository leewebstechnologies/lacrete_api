                        ...
                        <div class="row">
                            <div class="col-xl-12">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <form action="{{ route('store.testimonial') }}" method="post" class="row g-3" enctype="multipart/form-data">
                                            @csrf
                                            <div class="col-md-6">
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <textarea class="form-control" name="comment" placeholder="Required example textarea"></textarea>
                                            </div>
